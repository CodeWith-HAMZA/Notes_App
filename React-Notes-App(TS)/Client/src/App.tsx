import { Cottage, EditLocationOutlined } from "@mui/icons-material";
...
const App: React.FC = (): JSX.Element => {
  ...
  const addTodo = () => {
    ...
    setTodos([...Todos, todoObj] as Todo[]);
  ...
  const handleClickOpen: (uid: number | null) => void = function (
    ...
    if (uid) {
      ...
      const [{ _todoTitle, _todoDesc }] = Todos.filter(
        (todo) => todo._id === uid
      );
  ...
  const showAlert: (alertType: AlertColor | undefined) => void = function (
      ...
      >
        ...
        <Container maxWidth="lg">
          <Routes>
            ...
            />
            <Route path="/login" element={(<Login />) as JSX.Element} />
